...
const productos = [
    { id: 'A1034', nombre: 'Sosten Señora', precio: 3000, stock: 8, imagen: '../imagenesGeneralSostenes/Moda Mujer Modelar (1).jpg', miniaturas: ['../imagenesGeneralSostenes/Moda Mujer Modelar (1).jpg', '../imagenesGeneralSostenes/Moda Mujer Modelar (1).jpg'] , descripcion: 'Sujetadores diseñados para mujeres adultas, con mayor soporte y comodidad.' },
    { id: 'A1035', nombre: 'Sostén Juvenil', precio: 3000, stock: 8, imagen: '../imagenesGeneralSostenes/Moda Mujer Modelar.jpg', miniaturas: ['../imagenesGeneralSostenes/Moda Mujer Modelar.jpg', '../imagenesGeneralSostenes/Moda Mujer Modelar.jpg'] , descripcion: 'Sujetadores ligeros y cómodos, ideales para chicas jóvenes en crecimiento.' },
];*/

const productos = [
    { 
        id: 'A1034', 
        nombre: 'Sosten Señora', 
        precio: 3000, 
        stock: 8, 
        imagen: '../imagenesGeneralSostenes/Moda Mujer Modelar (1).jpg', 
        miniaturas: ['../imagenesGeneralSostenes/Moda Mujer Modelar (1).jpg', '../imagenesGeneralSostenes/Moda Mujer Modelar (1).jpg'], 
        descripcion: 'Prenda íntima de corte brasileño, hecha de algodón para comodidad y frescura.', 
        tallas: ['XL'], // Tallas específicas para este producto
        colores: ['#ffffff', '#be8f57', '#000000'] // Colores específicos (usando códigos hexadecimales)
    },
    { 
        id: 'A1035', 
        nombre: 'Sostén Juvenil', 
        precio: 3000, 
        stock: 8, 
        imagen: '../imagenesGeneralSostenes/Moda Mujer Modelar.jpg', 
        miniaturas: ['../imagenesGeneralSostenes/Moda Mujer Modelar.jpg', '../imagenesGeneralSostenes/Moda Mujer Modelar.jpg'], 
