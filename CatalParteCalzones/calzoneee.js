...
const productos = [
    ...
    { id: 'A1003', nombre: 'Boxer Mujer', precio: 2000, stock: 20, imagen: '../imagenesGeneral/Moda Mujer Modelar.jpg', miniaturas: ['../imagenesGeneral/Moda Mujer Modelar (1).jpg', '../imagenesGeneral/Moda Mujer Modelar (1).jpg'] , descripcion: 'Estilo de ropa interior femenina, cómodo y de corte largo.' },
    { id: 'A1004', nombre: 'Calzón Normal', precio: 1500, stock: 20, imagen: '../imagenesGeneral/Moda Mujer Modelar (1).jpg', miniaturas: ['../imagenesGeneral/Moda Mujer Modelar (2).jpg', '../imagenesGeneral/Moda Mujer Modelar (2).jpg'] , descripcion: 'Calzón de corte tradicional, básico y cómodo para uso diario.' },
    ...
    { id: 'A1007', nombre: 'Calzon Peruano', precio: 1500, stock: 20, imagen: '../imagenesGeneral/Moda Mujer Modelar.jpg' , miniaturas: ['../imagenesGeneral/Moda Mujer Modelar (1).jpg', '../imagenesGeneral/Moda Mujer Modelar (1).jpg'] , descripcion: 'Calzón ajustado, de alta calidad, muy popular en Perú.' },
    { id: 'A1009', nombre: 'Calzón Juvenil', precio: 2000, stock: 20, imagen: '../imagenesGeneral/Moda Mujer Modelar (1).jpg', miniaturas: ['../imagenesGeneral/Moda Mujer Modelar (2).jpg', '../imagenesGeneral/Moda Mujer Modelar (2).jpg'] , descripcion: 'Calzón con diseño fresco y juvenil, ideal para adolescentes.' },
    { id: 'A1010', nombre: 'Calzón Bikines', precio: 2000, stock: 20, imagen: '../imagenesGeneral/Moda Mujer Modelar (2).jpg' , miniaturas: ['../imagenesGeneral/Moda Mujer Modelar.jpg', '../imagenesGeneral/Moda Mujer Modelar.jpg'] , descripcion: 'Calzón de corte bajo, cómodo y de estilo bikini.' },
    ...
    { id: 'A1020', nombre: 'Cuadro Invisible', precio: 2000, stock: 20, imagen: '../imagenesGeneral/Moda Mujer Modelar (2).jpg' , miniaturas: ['../imagenesGeneral/Moda Mujer Modelar.jpg', '../imagenesGeneral/Moda Mujer Modelar.jpg'] , descripcion: 'Calzón diseñado para no marcarse bajo la ropa ajustada.' },
    { id: 'A1021', nombre: 'Colale Invisible', precio: 2000, stock: 20, imagen: '../imagenesGeneral/Moda Mujer Modelar.jpg' , miniaturas: ['../imagenesGeneral/Moda Mujer Modelar (1).jpg', '../imagenesGeneral/Moda Mujer Modelar (1).jpg'] , descripcion: 'Colale sin costuras, perfecto para no dejar marcas visibles' },
];*/
...
const productos = [
    ...
    { 
        ...
        descripcion: 'Estilo de ropa interior femenina, cómodo y de corte largo.', 
    ...
    { 
        id: 'A1009', 
        nombre: 'Calzón Juvenil', 
        precio: 2000, 
        stock: 20, 
        imagen: '../imagenesGeneral/Moda Mujer Modelar (1).jpg', 
        miniaturas: ['../imagenesGeneral/Moda Mujer Modelar (1).jpg', '../imagenesGeneral/Moda Mujer Modelar (1).jpg'], 
        descripcion: 'Calzón con diseño fresco y juvenil, ideal para adolescentes.', 
        tallas: ['M', 'L'], // Tallas específicas para este producto
        colores: ['#ffffff', '#979797', '#483cf1', '#000000'] // Colores específicos (usando códigos hexadecimales)
    },
    { 
        id: 'A1010', 
        nombre: 'Calzón Bikines', 
        precio: 2000, 
        stock: 20, 
        imagen: '../imagenesGeneral/Moda Mujer Modelar (2).jpg', 
        miniaturas: ['../imagenesGeneral/Moda Mujer Modelar.jpg', '../imagenesGeneral/Moda Mujer Modelar.jpg'], 
        descripcion: 'Calzón de corte bajo, cómodo y de estilo bikini.', 
        tallas: ['L', 'XL'], // Tallas específicas para este producto
        colores: ['#ffffff', '#979797', '#483cf1', '#000000'] // Colores específicos (usando códigos hexadecimales)
    },
    { 
    ...
    { 
        id: 'A1020', 
        nombre: 'Cuadro Invisible', 
        precio: 2000, 
        stock: 20, 
        imagen: '../imagenesGeneral/Moda Mujer Modelar (2).jpg', 
        miniaturas: ['../imagenesGeneral/Moda Mujer Modelar.jpg', '../imagenesGeneral/Moda Mujer Modelar.jpg'], 
        descripcion: 'Calzón diseñado para no marcarse bajo la ropa ajustada.', 
        tallas: ['L', 'XL', 'XXL'], // Tallas específicas para este producto
        colores: ['#ffffff', '#979797', '#483cf1', '#000000'] // Colores específicos (usando códigos hexadecimales)
    },
    { 
        id: 'A1021', 
        nombre: 'Colale Invisible', 
        precio: 2000, 
        stock: 20, 
        imagen: '../imagenesGeneral/Moda Mujer Modelar.jpg', 
        miniaturas: ['../imagenesGeneral/Moda Mujer Modelar.jpg', '../imagenesGeneral/Moda Mujer Modelar.jpg'], 
        descripcion: 'Colale sin costuras, perfecto para no dejar marcas visibles.', 
        tallas: ['L', 'XL', 'XXL'], // Tallas específicas para este producto
        colores: ['#ffffff', '#979797', '#483cf1', '#000000'] // Colores específicos (usando códigos hexadecimales)
    },
